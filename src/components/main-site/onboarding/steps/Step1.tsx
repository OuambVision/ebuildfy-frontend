        ...
        <div className="flex flex-col gap-6">
            ...
            <div>
                ...
                <h2 className="text-sm font-bold mb-2">
                    Bienvenue sur eBuildfy !
                </h2>
                <p>
                    Avant de commencer à vendre, prenez une minute pour
                    configurer les éléments essentiels de votre boutique :
                </p>
            </div>
            ...
            <p className="mt-6 italic">
                ...
                <span className="font-bold">une minute</span> seulement pour
                compléter ces étapes et commencer à vendre.
            </p>
